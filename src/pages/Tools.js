        ...
        <Col>
          <Form>
            ...
            <FormGroup check>
              ...
              <FormGroup>
              <Button color="primary" onClick={(option==="") ? ()=>{setError(true)} : (option==="follow") ? FollowGenerateHandler :  unFollowGenerateHandler }>Generate</Button>
              </FormGroup>
              {error ? (<Alert color="danger">Select follow or unfollow process!</Alert>) : ""}
